...
#===============Tax==============
    ...
    def total(self):
        ...
        self.c_face_cream_price=self.face_cream.get()*180
        self.c_face_wash_price=self.face_wash.get()*160
        self.c_spray_price=self.spray.get()*400
        self.c_gell_price=self.gell.get()*140
        self.c_loshan_price=self.loshan.get()*320
        ...
        self.c_tax=round((self.total_cosmetic_price*0.15),2)
        self.cosmetic_tax.set("Tk "+str(self.c_tax))

        self.g_rice_price=self.rice.get() * 40
        self.g_food_oil_price=self.food_Oil.get() * 120
        self.g_daal_price=self.daal.get() * 120
        self.g_wheat_price=self.wheat.get() * 100
        self.g_sugar_price=self.sugar.get() * 140
        self.g_tea_price=self.tea.get() * 250
        ...
        self.co_cocacola_price=self.cocacola.get() * 80
        self.co_sprite_price=self.sprite.get() * 750
        self.co_fanta_price=self.fanta.get() * 60
        self.co_pepsi_price=self.pepsi.get() * 50
        self.co_juice_price=self.juice.get() * 100
        self.co_sevenup_price=self.sevenup.get() * 80
        ...
        self.cold_tax=round((self.total_cold_drink_price*0.15),2)
